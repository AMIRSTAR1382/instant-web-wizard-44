...
const Index = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="ml-16 mr-80 p-8">
        <div className="max-w-5xl mx-auto">
          <div className="relative mb-8">
            ...
            <input
              type="text"
              placeholder="Explore"
              className="w-full bg-secondary border border-border rounded-xl py-3 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-ring transition-all"
            />
          </div>
