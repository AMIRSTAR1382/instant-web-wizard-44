  ...
  return (
    <>
      ...
      >
        ...
        {/* Main Content */}
        <div
          className={`absolute inset-0 p-6 overflow-y-auto transition-transform duration-300 ease-out ${activePanel !== "main" ? "-translate-x-full" : "translate-x-0"
            }`}
        >
        ...
        {/* Settings Panel */}
        <div
          className={`absolute inset-0 p-6 overflow-y-auto transition-transform duration-300 ease-out ${activePanel === "settings" ? "translate-x-0" : "translate-x-full"
            }`}
        >
        ...
        {/* Notifications Panel */}
        <div
          className={`absolute inset-0 p-6 overflow-y-auto transition-transform duration-300 ease-out ${activePanel === "notifications" ? "translate-x-0" : "translate-x-full"
            }`}
        >
          <div className="flex items-center gap-3 mb-8">
            <button
